...
# Download the last two years of weekly data
...
function download_weekly() {
	...
	curl --silent "https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY_ADJUSTED&symbol=${ticker}&datatype=csv&apikey=${API_KEY}" | \
