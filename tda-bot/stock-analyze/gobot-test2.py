...
scenarios = {
               ...
               'stochrsi_aroonosc_simple_dmi_simple_with_macd_adx_standard_rs_strict_etfemd0.05_bl':   '--rsi_high_limit=75 --rsi_low_limit=25 --stochrsi_offset=3 \
                                                                ...
                                                                --decr_threshold=1.25 --use_combined_exit --skip_perma_blacklist --etf_use_emd --etf_emd_fraction=0.05',

               'stochrsi_aroonosc_simple_dmi_simple_with_macd_adx_standard_rs_strict_etfemd0.1_bl':   '--rsi_high_limit=75 --rsi_low_limit=25 --stochrsi_offset=3 \
                                                                --with_dmi_simple --with_aroonosc_simple --aroonosc_with_macd_simple --with_adx --adx_threshold=6 \
                                                                --use_natr_resistance --min_intra_natr=0.15 --min_daily_natr=6 \
                                                                --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 --etf_min_natr=0.1 \
                                                                --decr_threshold=1.25 --use_combined_exit --skip_perma_blacklist --etf_use_emd --etf_emd_fraction=0.1',

               'stochrsi_aroonosc_simple_dmi_simple_with_macd_adx_standard_rs_strict_etfemd0.15_bl':   '--rsi_high_limit=75 --rsi_low_limit=25 --stochrsi_offset=3 \
                                                                --with_dmi_simple --with_aroonosc_simple --aroonosc_with_macd_simple --with_adx --adx_threshold=6 \
                                                                --use_natr_resistance --min_intra_natr=0.15 --min_daily_natr=6 \
                                                                --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 --etf_min_natr=0.1 \
                                                                --decr_threshold=1.25 --use_combined_exit --skip_perma_blacklist --etf_use_emd --etf_emd_fraction=0.15',

               'stochrsi_aroonosc_simple_dmi_simple_with_macd_adx_standard_rs_strict_etfemd0.2_bl':   '--rsi_high_limit=75 --rsi_low_limit=25 --stochrsi_offset=3 \
                                                                --with_dmi_simple --with_aroonosc_simple --aroonosc_with_macd_simple --with_adx --adx_threshold=6 \
                                                                --use_natr_resistance --min_intra_natr=0.15 --min_daily_natr=6 \
                                                                --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 --etf_min_natr=0.1 \
                                                                --decr_threshold=1.25 --use_combined_exit --skip_perma_blacklist --etf_use_emd --etf_emd_fraction=0.2',
...
#								--use_combined_exit --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 ',
...
#                                                                --with_stacked_ma --stacked_ma_periods=34,55,89 --stacked_ma_type=wma \
#                                                                --min_intra_natr=0.65 --min_daily_natr=6 --use_trend --use_bbands_kchannel_xover_exit --bbands_roc_threshold=0 \
#								--use_combined_exit --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 --skip_blacklist ',
...
#								--with_stacked_ma --stacked_ma_periods=34,55,89 --stacked_ma_type=wma \
#								--min_intra_natr=0.65 --min_daily_natr=6 --use_trend --use_bbands_kchannel_xover_exit --bbands_roc_threshold=0 \
#								--bbands_roc_strict --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 --etf_min_natr=0.1 \
...
#		'stochstackedma_bbands_kchannel8_standard_kama_trima_mamafama_rs_bl':	'--primary_stoch_indicator="stacked_ma" \
...
#								--with_mama_fama \
#								--with_bbands_kchannel --bbands_kchannel_offset=0.15 --bbands_kchan_squeeze_count=8 \
#								--use_bbands_kchannel_xover_exit --bbands_roc_threshold=0 \
#								--min_intra_natr=0.65 --min_daily_natr=6 \
#								--check_etf_indicators --etf_min_rs=4 --etf_min_natr=0.1 \
#								--decr_threshold=1.25 --use_combined_exit  --skip_perma_blacklist ',

#		'stochstackedma_bbands_kchannel8_standard_kama_trima_mamafama_rs11_bl':	'--primary_stoch_indicator="stacked_ma" \
#								--stacked_ma_periods_primary=5,8,13 --stacked_ma_type_primary=kama --use_trend \
#								--with_stacked_ma --stacked_ma_periods=34,55,89 --stacked_ma_type=trima \
#								--with_mama_fama \
#								--with_bbands_kchannel --bbands_kchannel_offset=0.15 --bbands_kchan_squeeze_count=8 \
#								--use_bbands_kchannel_xover_exit --bbands_roc_threshold=0 \
#								--min_intra_natr=0.65 --min_daily_natr=6 \
#								--check_etf_indicators --etf_min_rs=11 --etf_min_natr=0.1 \
#								--decr_threshold=1.25 --use_combined_exit  --skip_perma_blacklist ',
...
#                                                                --check_etf_indicators --check_etf_indicators_strict --etf_min_rs=4 --skip_blacklist ',
