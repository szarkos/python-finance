...
nohup ./tda-stochrsi-gobot-v2.py --stoploss --stock_usd=50000 --stocks=${tickers} --short --singleday \
	...
	\
	--algos=algo_id:main,primary_stochrsi,dmi_simple,aroonosc,adx,support_resistance,adx_threshold:6,min_daily_natr:6 \
	--algos=algo_id:main2,primary_stochrsi,dmi_simple,aroonosc,adx,support_resistance,adx_threshold:6,supertrend,min_daily_natr:3 \
	\
	--rsi_high_limit=85 --rsi_low_limit=15 --stochrsi_offset=3 \
