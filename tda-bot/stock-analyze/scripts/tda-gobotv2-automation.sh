...
nohup ./tda-stochrsi-gobot-v2.py --stoploss --stock_usd=5000 --stocks=${tickers} --short --singleday \
	--decr_threshold=0.4 --incr_threshold=0.5 --max_failed_txs=2 --exit_percent=1 \
	--algos=algo_id:main,primary_stochrsi,dmi_simple,aroonosc,adx,support_resistance,adx_threshold:6 \
	\
