...
if ( args.tos_indicator == False ):
	...
	# Value area high/low
	print()
	print('VAH 1-day (' + str(date_1) + '): ' + str(vah_1))
	print('VAL 1-day (' + str(date_1) + '): ' + str(val_1))
	print('VAH 2-day (' + str(date_2) + '): ' + str(vah_2))
	print('VAL 2-day (' + str(date_2) + '): ' + str(val_2))
...
# ToS indicator
	...
	print( "#\n# Level Color Codes:" )
	print( '#  - Red      - Weekly Filtered' )
	print( '#  - Purple   - Weekly unfiltered with multiple hits' )
	print( '#  - Dark Red - Daily unfiltered with multiple hits' )
	print( '#  - Orange   - Previous 1-day and 2-day (dotted line) VAH/VAL' )
	print()
	...
	print( 'vah_1.SetDefaultColor(CreateColor(210, 132, 0));' ) # Orange
	print( 'plot val_1 = ' + str(val_1) + ';' )
	print( 'val_1.SetDefaultColor(CreateColor(210, 132, 0));' )
	print()

	# Two-day VAH/VAL paint with dashed lines
	print( 'plot vah_2 = ' + str(vah_2) + ';' )
	print( 'vah_2.SetDefaultColor(CreateColor(210, 132, 0));' )
	print( 'vah_2.SetPaintingStrategy(PaintingStrategy.DASHES);' )
	print( 'plot val_2 = ' + str(val_2) + ';' )
	print( 'val_2.SetDefaultColor(CreateColor(210, 132, 0));' )
